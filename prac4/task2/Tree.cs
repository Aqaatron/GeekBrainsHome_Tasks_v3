...
namespace task2
{
    public class Tree : ITree
    {
        ...
        {
            //string node1 = "__________|__________";
            //string node2 = "|                   |";
            //string node3 = "___|___";
            //string node4 = "|     |";
            int startX = 60;
            int startY = 1;
            //int marginX = (node1.Length - node1.Length % 2) / 2;
            int marginYRight = 3;
            ...
            Console.Write("|");
            //Console.SetCursorPosition(startX - marginX, startY + marginY);
            //Console.Write(node1);
            //marginY++;
            //Console.SetCursorPosition(startX - marginX, startY + marginY);
            //Console.Write(node2);
